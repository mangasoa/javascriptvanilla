(function (window, document) {
    ...
    function init() {
        ...
        // wait for wpdateCompies and then execute updateTable
    ...
    function updateTable() {
        ...
        function onTranslationsReady(translations) {
            ...
            console.log(translations.types)
    ...
    function updateCompanies() {
        return dataService.getCompanies().then(function (companies) {
            // returning a promise because setTimeout function is used in getCompanies function 
    ...
    function getTasks(typeTranslations) {
        ...
        function getTaskItemFromXml(task, typeTranslations) {
            ...
            //or operator is used to set translation value so we will remove the or and we only keep the vlaue of translation 
           // taskItem.TxtType = typeTranslations[taskItem.TxtType] || taskItem.TxtType;
            taskItem.TxtType = typeTranslations[taskItem.TxtType];
            return taskItem;
        }
    }
